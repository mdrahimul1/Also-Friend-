    ...
    return (
        <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm p-8 rounded-2xl shadow-2xl border border-gray-700">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-400 mt-2">আপনার অ্যাকাউন্টে লগইন করুন</p>
            </div>
            ...
            <p className="text-center text-gray-400 text-sm mt-6">
                ...
                <button onClick={switchToRegister} className="font-bold text-blue-500 hover:text-blue-400 transition-colors bg-transparent border-none">
                    রেজিস্টার করুন
                </button>
            </p>
        </div>
